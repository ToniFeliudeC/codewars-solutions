...
def goose_filter(birds):
    ...
    #This array will eventually contain our final result.
    newBirds = []
    
    #We loop through the netire "birds" array and, in case an element is not IN the "geese" array, we append it to the 
    #"newBirds" array.
    for i in birds:
        if i not in geese:
            newBirds.append(i)
